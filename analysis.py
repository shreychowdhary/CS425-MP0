...
fig1 = plt.figure(1)
plt.plot(range(0, 100), median_vals)
plt.plot(range(0, 100), max_vals)
plt.plot(range(0, 100), min_vals)
plt.plot(range(0, 100), ninety_vals)
...
plt.xlabel("Time in seconds since first connection")
plt.plot(range(0, 100), kilobits_per_second)
plt.show()
